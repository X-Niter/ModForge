    ...
    >
      <div className="flex flex-col h-full">
        ...
        <nav className="flex-1 overflow-y-auto hide-scroll py-2">
          <button className="sidebar-btn active w-full text-left px-4 py-2 flex items-center text-white hover:bg-gray-700">
            <svg
          ...
          <button className="sidebar-btn w-full text-left px-4 py-2 flex items-center text-white hover:bg-gray-700">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="mr-3"
              width="20"
