    ...
    >
      <div className="flex flex-col h-full">
        ...
        <nav className="flex-1 overflow-y-auto hide-scroll py-2">
          <Link href="/">
            <a className={`sidebar-btn ${location === '/' ? 'active' : ''} w-full text-left px-4 py-2 flex items-center text-white hover:bg-gray-700`}>
              <svg
          ...
          <Link href="/code-explorer">
            <a className={`sidebar-btn ${location === '/code-explorer' ? 'active' : ''} w-full text-left px-4 py-2 flex items-center text-white hover:bg-gray-700`}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="mr-3"
                width="20"
          ...
          <Link href="/compilation">
            <a className={`sidebar-btn ${location === '/compilation' ? 'active' : ''} w-full text-left px-4 py-2 flex items-center text-white hover:bg-gray-700`}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="mr-3"
                width="20"
          ...
          <Link href="/build-history">
            <a className={`sidebar-btn ${location === '/build-history' ? 'active' : ''} w-full text-left px-4 py-2 flex items-center text-white hover:bg-gray-700`}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="mr-3"
                width="20"
          ...
          <Link href="/github-integration">
            <a className={`sidebar-btn ${location === '/github-integration' ? 'active' : ''} w-full text-left px-4 py-2 flex items-center text-white hover:bg-gray-700`}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="mr-3"
                width="20"
          ...
          <Link href="/settings">
            <a className={`sidebar-btn ${location === '/settings' ? 'active' : ''} w-full text-left px-4 py-2 flex items-center text-white hover:bg-gray-700`}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="mr-3"
                width="20"
