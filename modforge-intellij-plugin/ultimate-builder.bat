...
:configure_gradle
    ...
    :: Clean up path for Gradle
    set "NORMALIZED_PATH=%JAVA_PATH:\=/%"
    ...
    (
        ...
        echo org.gradle.java.home=%NORMALIZED_PATH%
        echo.
    ...
    call :log "Updated gradle.properties with correct Java home path"
    exit /b 0
