...
/**
 * Contributor for Quilt mod loader.
 */
public class QuiltLoaderContributor implements ModLoaderContributor {
    private static final Logger LOG = Logger.getInstance(QuiltLoaderContributor.class);
    ...
    public boolean detectModLoader(@NotNull Project project, @NotNull VirtualFile baseDir) {
        // Look for build.gradle with Quilt dependency
