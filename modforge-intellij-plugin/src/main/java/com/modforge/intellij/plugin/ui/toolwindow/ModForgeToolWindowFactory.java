...
public final class ModForgeToolWindowFactory implements ToolWindowFactory {
    ...
    private JComponent createDashboardPanel(@NotNull Project project) {
        ModAuthenticationManager authManager = ApplicationManager.getApplication()
                .getService(ModAuthenticationManager.class);
        GitHubIntegrationService gitHubService = ApplicationManager.getApplication()
                .getService(GitHubIntegrationService.class);
        AutonomousCodeGenerationService codeGenService = ApplicationManager.getApplication()
                .getService(AutonomousCodeGenerationService.class);
        ...
        JButton toggleCDButton = new JButton(codeGenService.isRunningContinuously() ? "Stop Continuous Development"
    ...
    private JComponent createSettingsPanel(@NotNull Project project) {
        ...
        JCheckBox patternRecognitionCheckBox = new JCheckBox("Enable Pattern Recognition",
                settings.isPatternRecognition());
        featurePanel.add(patternRecognitionCheckBox);

        JCheckBox continuousDevelopmentCheckBox = new JCheckBox("Enable Continuous Development",
                settings.isEnableContinuousDevelopment());
        ...
        saveButton.addActionListener(e -> {
            ...
            settings.setCheckIntervalMs((int) timeoutSpinner.getValue());
