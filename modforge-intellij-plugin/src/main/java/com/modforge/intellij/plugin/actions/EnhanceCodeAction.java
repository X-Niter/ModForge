            ...
            ProgressManager.getInstance().run(new Task.Backgroundable(project, "Enhancing Code") {
                ...
                public void run(@NotNull ProgressIndicator indicator) {
                    try {
                        ...
                        String serverUrl = settings.getServerUrl(); // Deprecated: Consider replacing with an
                        ...
                        // Create API client
                        com.modforge.intellij.plugin.api.ApiClient apiClient = new com.modforge.intellij.plugin.api.ApiClient(
                                serverUrl);
                        ...
                        String responseJson = apiClient.post("/api/code/enhance", inputDataJson);
                        ...
                        com.intellij.openapi.application.ApplicationManager.getApplication().invokeLater(() -> {
                            try {
                                ...
                                com.modforge.intellij.plugin.dialogs.CodeEnhancementDialog dialog = new com.modforge.intellij.plugin.dialogs.CodeEnhancementDialog(
                                        project,
                                        selectedText,
                                        enhancedCode,
                                        explanation,
                                ...
                                ModForgeNotificationService localNotificationService = ModForgeNotificationService
                                        .getInstance();
