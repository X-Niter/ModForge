...
public final class CollaborationService {
     ...
     * @deprecated Use {@link #removeParticipant(String)} which returns a boolean
     *             result
     */
    @Deprecated
     ...
     * 
     * @return A CompletableFuture that completes with true if successful, false
     *         otherwise
     */
     ...
     * @return A CompletableFuture that completes with the session ID when
     *         successful
     */
    ...
    /**
     * Sends a notification that a participant has been added to the collaboration
     * session.
     * This method is for UI notifications only and doesn't update the internal
     * participant list.
     * 
    ...
    public void applyOperation(String filePath, EditorOperation operation, String userId) {
        ...
        // This would typically involve using the IntelliJ editor API to apply the
        // change
